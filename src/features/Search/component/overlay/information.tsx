...
export default function Information({ detail, setsetPrice, onSubmits }: InformationProps) {
  ...
  const checkCategoryOverlay = ['piza', 'newDish', 'mixed', 'Seafood', 'Stuffing', 'Traditional'];
  return (
    <form onSubmit={handleSubmit}>
      <div className="ovelay_info">
        ...
        {checkCategoryOverlay.includes(category) && (
          <>
            ...
            <div className="overlay_size">
              ...
              <div className="size_list">
                {size?.map((items: AppertizerFeaturesProps, index: number) => (
                  <div
                    key={items.id}
