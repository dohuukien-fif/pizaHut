...
import PizzaSeafood from '../component/pizaList/seafoodsList';
import LoadingListss from './../../../../../component/loadingFeatures/loadingList/index';
export default function PizaSeafoodFeatures(props: any) {
          ...
          <div className="salad_new" id="section1">
            <div className="new">
              ...
              {LoadingList ? (
                ...
                <PizzaSeafood data={DataPiza} setIdPizza={setIdPizza} />
              )}
            </div>
          </div>
        </div>
