...
import PizzaTradition from '../component/pizaList/traditionalList';
import LoadingListss from './../../../../../component/loadingFeatures/loadingList/index';
export default function PizaTraditioalFeatures(props: any) {
          ...
          <div className="salad_new" id="section1">
            <div className="new">
              ...
              {LoadingList ? (
                ...
                <PizzaTradition data={DataPiza} setIdPizza={setIdPizza} />
              )}
            </div>
          </div>
        </div>
