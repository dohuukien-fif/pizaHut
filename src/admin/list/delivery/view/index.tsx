...
import './styles.scss';
export interface ViewDeliveryFeatuesProps {}

export default function ViewDeliveryFeatues(props: ViewDeliveryFeatuesProps) {
  const { deliveryId } = useParams();

  console.log('deliveryId', deliveryId);
  const { data, LoadingSearch } = useViewOrder(deliveryId);
